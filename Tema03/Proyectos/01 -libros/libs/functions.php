...
// Función para obtener el índice de un libro por su id
...
//     array_multisort($columna, SORT_ASC, $array);              // Y lo ordenamos usando la funcion para arrays multidimensionales.
// }