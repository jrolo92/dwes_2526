...
<body>
    ...
    <div class="container mt-3">
        ...
        <main>
            <?php $var = 1 ?>
            <?php while ($var <= 10): ?>
                <p>El valor de la variable es <?= $var ?></p>
            <div class="form-floating mb-3">
                <input type="email" class="form-control" id="floatingInput<?= $var ?>" placeholder="name@example.com">
                <label for="floatingInput<?= $var ?>">Email address</label>
            </div>
            <?php $var++; ?>
            <?php endwhile; ?>
