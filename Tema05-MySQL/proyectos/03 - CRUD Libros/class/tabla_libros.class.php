...
class class_tabla_libros extends class_conexion
{
    ...
    /*
    método:  get_libros()
    descripción: extrae los lirbos de  la  tabla libros
    parámetros: ninguno
    ...
    public function get_libros()
    {
        ...
        try {
            ...
            $sql = "SELECT 
                        ...
                        GROUP_CONCAT(temas.tema SEPARATOR ', ') AS generos,
                        libros.stock,
                        libros.precio_venta
                    ...
                    INNER JOIN libros_temas
                        ON libros.id = libros_temas.libro_id
                    INNER JOIN temas
                        ON libros_temas.tema_id = temas.id
                    GROUP BY libros.id , libros.titulo , autores.nombre , editoriales.nombre , libros.stock , libros.precio_venta
                    ORDER BY 1"
            ;
