...
<body>
    ...
    <div class="container mt-3">
        ...
        <main>
            ...
            <form action="update.php?id=<?=$articulo_id; ?>" method="POST">
                <div class="mb-3">
                ...
                <select class="form-select" aria-label="Default select example" name="categoria_id" id="categoria_id" value="<?=htmlspecialchars($articulo['categoria'])?>">                 
